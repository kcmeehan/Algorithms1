#!/usr/bin/python
'''
Programming assignment number 3 -- Part 2
'''
...
def partition(subArray, leftIndex, rightIndex, nCompareCount):
    ...
    # Choose last array element as pivot
    pivot = subArray[rightIndex-1]

    subArray[rightIndex-1], subArray[leftIndex] = subArray[leftIndex], subArray[rightIndex-1]
